...
@Preview(showBackground = true, name = "Experience Section Preview")
@Composable
fun ExperienceSectionContentPreview() {
    ResumeTheme {
        Box(modifier = Modifier.fillMaxSize()) {
            ExperienceSectionContent(experience = mockResumeData.experiences)
        }
    }
}